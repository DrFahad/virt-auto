...
//$projectRoot='/week4task1-2';
        ...
        */
        ...
        //$rand_keys = array_rand($imageSet, $totalImages);
        //echo $imageSet[rand(0, count($imageSet)-1)]."<br/>";
        shuffle($imageSet);
        $randomElements = array_slice($imageSet, 0, 10);
        foreach ($randomElements as $key => $value) {
            //echo "Key= ".$key."<br/>";
            echo "Value= ".$value."<br/>";
        }
//glob is used to search the image directory for filename
        foreach ($rand_keys as $relativeImagePath) {
